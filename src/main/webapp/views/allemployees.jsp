...
<body>
	<nav class="navbar">
		...
		<ul class="navbar-list">
			...
			<li><a href="allemployees"><button type="button">All
						Employees</button></a></li>
		</ul>
		...
		<div class="profile-dropdown">
			...
			<div class="profile-dropdown-list">
				<ul>
					...
					<li class="profile-dropdown-list-itms"><a href="timesheet.jsp">
							<i class="fa-solid fa-chart-line"></i> TimeSheets
					</a></li>
	...
	<div
		...
		<h2
			style="font-size: 1.5vw; float: left; margin-left: 10vw; margin-bottom: 0vw; font-family: Tahoma, Geneva, Verdana, sans-serif;">Employees
			:</h2>
		<select id="userfilter"
			style="float: right; margin: 0vw 2vw; outline: none; background-color: rgb(0, 0, 0, 0.1); color: rgb(0, 0, 2); font-weight: bold; font-size: 0.8vw; padding: 0.4vw; border-radius: 0.5vw;">
			<option selected="selected" disabled="disabled">Sort
				Employees</option>
	...
	<div class="arti">
		<c:forEach var="us" items="${users }">
			<div class="card">
				<div
					style="border-bottom: 0.15vw solid grey; overflow: auto; display: flex; justify-content: space-between; align-items: center;">
				...
				<div style="display: flex; justify-content: space-evenly;">
					...
					<a href="current-user?userId=${us.getUserId()}"><button
