...
<body>
	<nav class="navbar">
		<a href="adminhome"><h1 class="logo">AlphaAttendance.com</h1></a>
		<ul class="navbar-list">
			<li><a href="adminhome"><button type="button">Back</button></a>
			</li>
		</ul>
		...
		<div class="profile-dropdown">
			...
			<div class="profile-dropdown-list">
				<ul>
					...
					<li class="profile-dropdown-list-itms"><a
						href="/ams_mvc/views/timesheet.jsp"> <i
	...
	<br>
	<div id="timesheet">
		<form action="saveAdminTs">
			<p>select the date from when time sheet has to create</p>
			...
			</select> End Date <select name="endDate">
				<option value="01">01</option>
				<option value="02">02</option>
				<option value="03">03</option>
				<option value="04">04</option>
