...
<body>
      ...
      <li>
          <a href="allemployees"><button type="button">Employees</button></a>
        </li>
        <li>
	...
	<div class="main">
		...
		<a href="assignbatchtouser?id=${user1.getUserId() }"> <button class="but" type="submit">Assign Batchs</button> </a>
	...
	<div style="  overflow: auto; display: flex; align-items: center; justify-content: space-between;">
	 	<h2 style="font-size: 1.3vw; float: left; margin-left: 10vw; margin-bottom: 0vw; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; ">On_Going Batchs :</h2>
 	 </div>
<div class="arti">
	...
	<br>
	<div style="  overflow: auto; display: flex; align-items: center; justify-content: space-between;">
	 	<h2 style="font-size: 1.3vw; float: left; margin-left: 10vw; margin-bottom: 0vw; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; ">Completed Batchs :</h2>
 	 </div>
<div class="arti">
