...
select {
	...
	-moz-appearance: none;
	background:
		url("https://cdn.iconscout.com/icon/free/png-256/chevron-down-18-454643.png")
...
<body>
	...
	<form id="attendanceform" action="createattendancecreate" method="get">
		...
		<input type="hidden" value="${userId }" name="userId"> <input
			type="hidden" value="${timeSheetId }" name="timeSheetId"> <label
			for="date">Date:</label> <input type="date" name="date" id="date" />

		<label for="logintime">Login Time:</label> <input type="time"
			name="logintime" id="logintime" /> <label for="logouttime">Logout
			Time:</label> <input type="time" name="logouttime" id="logouttime" /> <label
			for="status">Status:</label> <select name="batchStatus" id="status">
